# Codex Development Protocol - Zaforge v0.12.0
...
This project uses **MCP servers** to enhance Codex CLI capabilities:
...
The Playwright MCP enables Codex to perform autonomous UI testing, visual verification, and console monitoring. Use it proactively when:
...
When Codex makes UI changes, it should:
...
**MCP Commands Reference for Codex:**
