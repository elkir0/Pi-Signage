...
function takeScreenshot() {
    ...
    $output = executeCommand(SCREENSHOT_SCRIPT);
    $screenshotPath = trim($output);
    
    if (file_exists($screenshotPath)) {
        // Copier vers le dossier web accessible
        $webPath = '/opt/pisignage/web/assets/screenshots/' . basename($screenshotPath);
        ...
        if (copy($screenshotPath, $webPath)) {
            return 'assets/screenshots/' . basename($screenshotPath);
        }
    }
