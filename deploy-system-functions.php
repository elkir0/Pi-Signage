<?php
// Script de déploiement temporaire pour system-functions.php
...
$targetFile = '/opt/pisignage/web/api/system-functions.php';

if (file_put_contents($targetFile, $content)) {
    echo json_encode(['success' => true, 'message' => 'File deployed successfully']);
} else {
