# Documentation API - PiSignage v0.8.1

## Vue d'ensemble

PiSignage v0.8.1 expose une API REST complète permettant de contrôler l'ensemble des fonctionnalités via des requêtes HTTP. L'API supporte les formats JSON et les uploads multipart/form-data.
...
Cette documentation couvre l'API complète de PiSignage v0.8.1. Pour des questions spécifiques, consultez les logs ou ouvrez une issue sur GitHub.